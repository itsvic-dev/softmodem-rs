...
The ITU download for V.21 often fails; the same text is in CCITT Blue Book
Fascicle VIII.1, pages 65 to 69, which also holds V.22 and V.25. Local copies
go in `docs/specs/`, which is not committed.
